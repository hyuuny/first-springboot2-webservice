...
public class PostsRepositoryTest {
    ...
    public void 게시글저장_불러오기() {
        ...
        // postsRepository : id값이 있으면 update, 없으면 insert문 실행
        postsRepository.save(Posts.builder().title(title).content(content)
                                                .author("shyune@knou.ac.kr").build());

        // when
        // 테이블 posts에 존재하는 모든 데이터를 조회하는 메서드
    ...
    public void BaseTimeEntity_등록() {
        ...
        postsRepository.save(Posts.builder().title("하하하").content("제곧내").author("author").build());
